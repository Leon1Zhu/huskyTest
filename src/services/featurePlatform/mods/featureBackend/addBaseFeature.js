...
export function mutate(
  ...
  return SWR.mutate(
    Hooks.getUrlKey('/featurePlatform/addBaseFeature.json', params, 'GET'),
    newValue,
    shouldRevalidate,
  );
}
...
export const url = '/featurePlatform/addBaseFeature.json';

export async function request(params = {}) {
  return Request({
    url: getUrl('/featurePlatform/addBaseFeature.json', params, 'GET'),
    params,
    method: 'get',
  });
}
