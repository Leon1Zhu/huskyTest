/**
 * @description 类目筛选，后续不再使用。当前还剩标签展示页未迁移
 */
...
export function mutate(
  ...
  return SWR.mutate(
    Hooks.getUrlKey('/category/getCategoryByIds.json', params, 'GET'),
    newValue,
    shouldRevalidate,
  );
}
...
export const url = '/category/getCategoryByIds.json';

export async function request(params = {}) {
  return Request({
    url: getUrl('/category/getCategoryByIds.json', params, 'GET'),
    params,
    method: 'get',
  });
}
