...
返回自定义评估结果
      ...
      export namespace getCustomEvalResult {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.AlgCustomEvalResult
        >;
...
返回结果ID
      ...
      export namespace createCustomEvalResult {
        ...
        export type Response = defs.autodm.ResultObject<number>;
...
返回自定义评估结果列表
      ...
      export namespace getCustomEvalResults {
        ...
        export type Response = defs.autodm.ResultObject<
          Array<defs.autodm.AlgCustomEvalResult>
        >;
...
返回数据集信息
      ...
      export namespace createOrUpdateDataset {
        ...
        export type Response = defs.autodm.ResultObject<boolean>;
...
返回标签上架日志
      ...
      export namespace getDeployLog {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.ObjectMap<string, ObjectMap>
        >;
...
返回模型类型列表
      ...
      export namespace getModelType {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.ListData<defs.autodm.Option>
        >;
...
返回迭代详情
      ...
      export namespace getIterationDetail {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.IterationDetailVOV2
        >;
...
返回迭代详情
      ...
      export namespace listIterationDetail {
        ...
        export type Response = defs.autodm.ResultObject<
          Array<defs.autodm.IterationDetailVOV2>
        >;
...
查询算法样本主键配置,用于特征做筛选
      ...
      export namespace getExamplePrimaryKeyInfo {
        ...
        export type Response = defs.autodm.ResultObject<
          Array<defs.autodm.PrimaryKeyInfoVO>
        >;
...
返回推荐特征列表
      ...
      export namespace listFeatures {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.ListData<defs.autodm.FeatureResponse>
        >;
...
返回标签信息
      ...
      export namespace getLabelInfo {
        ...
        export type Response = defs.autodm.ResultObject<defs.autodm.LabelInfo>;
...
返回二级特征分类列表
      ...
      export namespace compLog {
        ...
        export type Response = defs.autodm.ResultObject<string>;
...
返回二级特征分类列表
      ...
      export namespace listFeatureCategory {
        ...
        export type Response = defs.autodm.ResultObject<
          Array<defs.autodm.FeatureCategoryVOV2>
        >;
...
返回表的列信息列表
      ...
      export namespace getTableColumn {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.ListData<defs.autodm.TableColumnMetaVOV2>
        >;
...
返回表的列信息列表
      ...
      export namespace getTableColumnV2 {
        ...
        export type Response = defs.autodm.ResultObject<
          Array<defs.autodm.TableColumnMeta>
        >;
...
返回推荐特征列表
      ...
      export namespace listFeatures {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.ListData<defs.autodm.FeatureResponseVOV2>
        >;
...
返回模型类型列表
      ...
      export namespace getModelType {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.ListData<defs.autodm.OptionVOV2>
        >;
...
返回鉴权结果
      ...
      export namespace checkTableAndAuth {
        ...
        export type Response = defs.autodm.ResultObject<defs.autodm.AuthType>;
...
返回表的列信息列表
      ...
      export namespace getTableColumn {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.ListData<defs.autodm.TableColumnMeta>
        >;
...
返回应用列表
      ...
      export namespace listApplication {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.ListData<defs.autodm.DataApplicationVOV2>
        >;
...
返回资源列表
      ...
      export namespace apply {
        ...
        export type Response = defs.autodm.ResultObject<
          Array<defs.autodm.ApplyResourceVO>
        >;
...
返回运行任务列表
      ...
      export namespace listDeployInstances {
        ...
        export type Response = defs.autodm.ResultObject<
          Array<defs.autodm.DeployInstanceVOV2>
        >;
...
返回数据部署信息列表
      ...
      export namespace listDeploy {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.ListData<defs.autodm.DeployConfigVOV2>
        >;
...
数据停止调度，预检查，检查是否有应用
      ...
      export namespace preStopDeploy {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.ObjectMap<string, string>
        >;
...
返回算法实验列表
      ...
      export namespace listByName {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.ListData<defs.autodm.AlgStudyVO>
        >;
...
返回最优迭代结果
      ...
      export namespace getBestTrial {
        ...
        export type Response = defs.autodm.ResultObject<defs.autodm.AlgTrialVO>;
...
返回算法实验迭代列表
      ...
      export namespace listTrials {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.ListData<defs.autodm.AlgTrialVO>
        >;
...
返回标签预跑数据
      ...
      export namespace getPrerun {
        ...
        export type Response = defs.autodm.ResultObject<defs.autodm.PreRunData>;
...
返回算法实验
      ...
      export namespace get {
        ...
        export type Response = defs.autodm.ResultObject<defs.autodm.AlgStudyVO>;
...
返回最优迭代结果
      ...
      export namespace getBestTrial {
        ...
        export type Response = defs.autodm.ResultObject<
          defs.autodm.TrialStatisticVOV2
        >;
...
返回算法模型列表
      ...
      export namespace getAvailableAlgorithmList {
        ...
        export type Response = defs.autodm.ResultObject<
          Array<defs.autodm.ModelTypeVOV2>
        >;
...
返回潜客生产预测目标
    ...
    export namespace cateProp {
      ...
      export namespace listCatePropertyValues {
        ...
        export type Response = defs.autodm.ResultObject<
          Array<defs.autodm.CatePropValue>
        >;
      ...
      export namespace listIndustries {
        ...
        export type Response = defs.autodm.ResultObject<
          Array<defs.autodm.IndustryInfo>
        >;
...
返回任务ID
      ...
      export namespace testExecuteTask {
        ...
        export type Response = defs.autodm.ResultObject<ObjectMap>;
...
返回部署周期列表
    ...
    export namespace labelInfo {
      ...
      export namespace info {
        ...
        export type Response = defs.autodm.ResultObject<defs.autodm.JSONObject>;
    ...
    export namespace ntmOdps {
      ...
      export namespace instanceResult {
        ...
        export type Response = defs.autodm.ResultObject<Array<Array<string>>>;
...
返回样本信息
    ...
    export namespace task {
      ...
      export namespace taskDetailExecCommands {
        ...
        export type Response = defs.autodm.ResultObject<Array<string>>;
