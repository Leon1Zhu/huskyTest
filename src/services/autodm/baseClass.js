...
class PotentialCrowdAlgoConfigVO {
  /** crowdSize */
  crowdSize = undefined;
...
class ProduceSqlInfoResponse {
  /** exeSql */
  exeSql = '';

  /** odpsParams */
  odpsParams = undefined;
...
export const autodm = {
  ...
  Option,
  OptionVOV2,
  PotentialCrowdAlgoConfigVO,
  PotentialCrowdConfig,
  PreRunData,
  PrimaryKeyInfo,
  PrimaryKeyInfoVO,
  PrimaryKeyInfoVOV2,
  ProduceSqlInfoResponse,
  ResultObject,
  SampleVOV2,
  StatusInfo,
  StudyCopyVO,
